 ...
 * All logging should go through this class instead of direct console usage.
 *
 * @example
 * ```typescript
...
export class LoggerClass {
    private currentLevelValue = LogLevelNumeric.Debug;
 ...
 * Maintains backward compatibility with the previous static Logger API.
 */
